<template>
  <div class="result-container">
    ...
    <div class="content">
      ...
      <button class="next-button" @click="goToQuizPage5">다음 문제4</button>
    </div>
  </div>
</template>
...
export default {
  setup() {
    ...
    // QuizPage5로 이동
    const goToQuizPage5 = () => {
      router.push({ name: 'quizPage5', query: { questionIndex: 0 } }); // QuizPage5로 이동
    };

    return { selectedAnswer, resultText, goToQuizPage5 };
  },
};
</script>
